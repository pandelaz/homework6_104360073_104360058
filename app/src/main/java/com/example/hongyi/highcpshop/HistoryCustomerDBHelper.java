 ...
 */
public class HistoryCustomerDBHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "HighCP.db";
    private static final int DATABASE_VERSION = 1;

    public String TABLE_NAME = "HistoryCustomer";
    public static final String COLUMN_ID = "_id";
    public static final String COLUMN_CUSTOMERNAME = "customername";
    String ShopName,ShopIDD;//,CustomerName;

    public HistoryCustomerDBHelper(Context context, String ShopID) {
        ...
        TABLE_NAME = "HistoryCustomer"+ShopIDD;
