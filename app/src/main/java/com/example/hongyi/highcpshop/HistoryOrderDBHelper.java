 ...
 */
public class HistoryOrderDBHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "HighCP.db";
    private static final int DATABASE_VERSION = 1;

    public String TABLE_NAME = "HistoryOrder";
    ...
    public HistoryOrderDBHelper(Context context, String ShopID, String customername) {
        ...
        TABLE_NAME = "HistoryOrder"+ShopIDD+CustomerName;
        Log.d(TAG, "OrderDBHepler: HistoryOrder_TABLE_NAME = " + TABLE_NAME);
    }
    ...
    public boolean insertOrder(String customname, String productname, String quantity, String money, String totalmoney) {
        ...
        if(InsertOrUpdate == 0) {
            Log.d(TAG, "insertHistoryOrder: insert = " + TABLE_NAME);
            ...
            Log.d(TAG, "UpdateHistoryOrder: Update = " + newtotalmoney );
        }
